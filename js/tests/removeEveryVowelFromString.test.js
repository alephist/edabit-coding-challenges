const removeVowels = require("../removeEveryVowelFromString");
...
describe("removeVowels", () => {
  describe("Returns a new string with all vowels removed", () => {
    test.each(data)("removeVowels(%p) = %p", (str, result) => {
      let actual = removeVowels(str);
