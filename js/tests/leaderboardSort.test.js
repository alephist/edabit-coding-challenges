const leaderboards = require("../leaderboardSort");
...
describe("leaderboards", () => {
  describe("Return user array sorted by true score", () => {
    test.each(data)("leaderboards(%o) = %o", (users, result) => {
      let actual = leaderboards(users);
