const alphabetIndex = require("../alphabetPosition");
...
describe("alphabetIndex", () => {
  describe("Return string of alphabet position of each letter from input string", () => {
    test.each(data)("alphabetIndex(%p) = %p", (str, result) => {
      let actual = alphabetIndex(str);
