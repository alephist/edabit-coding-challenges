const lettersOnly = require("../showLettersOnly");
...
describe("lettersOnly", () => {
  describe("Return string without non-letters", () => {
    test.each(data)("lettersOnly(%p) = %p", (str, result) => {
      let actual = lettersOnly(str);
