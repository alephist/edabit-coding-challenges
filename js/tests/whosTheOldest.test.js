const oldest = require("../whosTheOldest");

const data = [
  [
    { Charlotte: 53, Oliver: 15, Henry: 18, Gabriel: 46, Violet: 13 },
    "Charlotte"
  ],
...
describe("oldest", () => {
  describe("Return the name of the oldest person", () => {
    test.each(data)("oldest(%p) = %p", (people, result) => {
      let actual = oldest(people);
