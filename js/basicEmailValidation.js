...
// The . and the @ must be in the appropriate places "hello.email@com" is invalid while "john.smith@email.com" is valid.
// If the string passes these tests, it's considered a valid email address.
// https://edabit.com/challenge/8rC8cbEonMKbHeLTx

const validateEmail = (str) => new RegExp(/\S+@\S+\.\S+/).test(str);
