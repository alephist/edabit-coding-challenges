...
from multiply_numbers_in_string import multiply_nums
...
class MultplyNumbersInStringTestCase(unittest.TestCase):
    def test_return_product_of_numbers_in_string(self):
        for nums, expected_product in test_values:
            with self.subTest():
                self.assertEqual(multiply_nums(nums), expected_product)
