const messageGlitch = require("../messageScreenGlitch");
...
const data = [
  ...
  [
    "R5m5m2e18 20o w1s8 1n25 13u7s l5f20 9n t8e k9t3h5n19.",
...
describe("messageGlitch", () => {
  describe("Return corrected message from glitched message", () => {
    test.each(data)("messageGlitch(%p) = %p", (txt, result) => {
      let actual = messageGlitch(txt);
