const multiplyNums = require("../multiplyingNumsInAString");
...
describe("multiplyNums", () => {
  describe("Return product of numbers from input string", () => {
    test.each(data)("multuplyNums(%p) = %p", (nums, result) => {
      let actual = multiplyNums(nums);
