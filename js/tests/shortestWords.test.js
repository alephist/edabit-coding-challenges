const findShortestWords = require("../shortestWords");
...
describe("findShortestWords", () => {
  describe("Return an array of shortest words from input string sorted alphabetically", () => {
    test.each(data)("findShortestWords(%p) = %p", (str, result) => {
      let actual = findShortestWords(str);
